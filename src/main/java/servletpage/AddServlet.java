...
StudentServices sv = new StudentServices();
    ...
    // Set the created at time in the request attribute
   
           
            String stuId = request.getParameter("id");
            String stuName = request.getParameter("full_name");
            String stuPass = request.getParameter("password");
            String stuEmail = request.getParameter("email");
            String stuPhone = request.getParameter("phone_number");
            String stuGender = request.getParameter("gender");
            String stuAddress = request.getParameter("address");
             
           
            sv.addStudent(stuId, stuName, stuPass, stuEmail, stuPhone, stuGender, stuAddress);
